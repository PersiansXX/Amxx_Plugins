...
#define DEFAULT_PMODEL	    "models/player/LS-2020-Normal/LS-2020-Normal.mdl"
#define DEFAULT_WMODEL	    "models/v_LS-2020-Normal.mdl"
...
public menuyuduzenle(id) {
    ...
    menu_additem(generBiomenu , "Cadi \r[\yWitch Zombie\r] \y[\r20 Level Gerekli\y]", "6", 0)	
    menu_additem(generBiomenu , "Hayalet \r[\yInvisible\r] \y[\r40 Level Gerekli\y]", "7", 0)	
